...
export class AddTransactionTable1715107146127 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            ...
            `);
    await queryRunner.query(
      `ALTER TABLE "Transaction" ADD CONSTRAINT "FK_32a6e4065ab9d7275321271d3ae" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "Transaction" ADD CONSTRAINT "FK_95df5765ab070a02eb29b82bd64" FOREIGN KEY ("bikeId") REFERENCES "Bikes"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
